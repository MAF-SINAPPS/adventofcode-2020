...
";
        ...
        public static void Part1() =>
            Debug.WriteLine($"{MethodBase.GetCurrentMethod().DeclaringType.Name} {MethodBase.GetCurrentMethod().Name}: " +
                _input.Split(Environment.NewLine + Environment.NewLine, StringSplitOptions.RemoveEmptyEntries).Count(_ =>
                    _.Split(new string[] { " ", Environment.NewLine }, StringSplitOptions.RemoveEmptyEntries).Count(__ =>
                        __.StartsWith("byr", StringComparison.OrdinalIgnoreCase) ||
                        __.StartsWith("iyr", StringComparison.OrdinalIgnoreCase) ||
                        __.StartsWith("eyr", StringComparison.OrdinalIgnoreCase) ||
                        __.StartsWith("hgt", StringComparison.OrdinalIgnoreCase) ||
                        __.StartsWith("hcl", StringComparison.OrdinalIgnoreCase) ||
                        __.StartsWith("ecl", StringComparison.OrdinalIgnoreCase) ||
                        __.StartsWith("pid", StringComparison.OrdinalIgnoreCase)
                    ) == 7));
        ...
        public static void Part2() =>
            Debug.WriteLine($"{MethodBase.GetCurrentMethod().DeclaringType.Name} {MethodBase.GetCurrentMethod().Name}: " +
                _input.Split(Environment.NewLine + Environment.NewLine, StringSplitOptions.RemoveEmptyEntries).Count(_ =>
                            _.Split(new string[] { " ", Environment.NewLine }, StringSplitOptions.RemoveEmptyEntries).Count(__ =>
                                Regex.IsMatch(__, @"byr:(19[2-9]\d)|(200[0-2])\b") ||
                                Regex.IsMatch(__, @"iyr:20(1\d|20)\b") ||
                                Regex.IsMatch(__, @"eyr:20(2\d|30)\b") ||
                                Regex.IsMatch(__, @"hgt:((1([5-8]\d|9[0-3])cm)|(59|6\d|7[0-6])in)\b") ||
                                Regex.IsMatch(__, @"hcl:#(\d|[a-f]){6}\b") ||
                                Regex.IsMatch(__, @"ecl:(amb|blu|brn|gry|grn|hzl|oth)\b") ||
                                Regex.IsMatch(__, @"pid:\d{9}\b")
                            ) == 7));
    }
}
